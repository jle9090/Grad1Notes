...
satPRN(prn_index) = struct('week_number', week_number_prn, 'TOW_s', TOW_s_prn, 'TOW_hr', TOW_hr_prn, ...
    'time_epoch_s', time_epoch_s_prn, 'time_epoch_hr', time_epoch_hr_prn, 'X_m', X_m_prn, 'Y_m', Y_m_prn, 'Z_m', Z_m_prn, ...
    'clock_bias_us', clock_bias_us_prn, 'constellation', constellation_prn, 'PRN', PRN_prn);
