...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/GPS_HW1_diagram1.png}
    \caption{Ranging Diagram}
    \label{fig:diagram1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/HW_Ranging_diagram2.png}
    \caption{Ranging Diagram}
    \label{fig:diagram2}
\end{figure}
...
theorem given $h_{0}$ is constant.
\[
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/HW1_sensitivity.png}
...
different aircraft positions, when farther away from the ground station,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/HW1_sensitivity_low_alt.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/hex_console_results.png}
    \caption{MATLAB C/A Code Generation Results}
    \label{fig:CA code gen results}
\end{figure}

When examining the outputs for the first 16 chips expressed
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/PRN19_Autocorrelation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/PRN19_PRN19_delay_200_Crosscorrelation.png}
...
this is the same code only shifted, the spike occurring at the amount we shifted
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/PRN25_PRN19_Crosscorrelation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/PRN5_PRN19_Crosscorrelation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/PRN5xsum_PRN19_Crosscorrelation.png}
...
PRN signals from a GPS satellite. Because of how these codes are constructed, these codes
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/subplot_x1x2x3_noise.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../MATLAB/figures/PRN5xsum_noise_PRN19_Crosscorrelation.png}
...
we do indeed observe that there is a noticeable peak at 350 in the lag axis. This is 
...
with the original code of PRN 19 we are examining. I am however rather surprised how based on
Figure \ref{fig:x1x2x3_noise_plot}, noise is comparatively very large compared to the chip values,
