...
xlabel('TOW (S)')
ylabel('Range (m)')
title('Range vs TOW (PRN 8)')
grid on
exportgraphics(gcf, fullfile('figures', 'ranging_PRN8.png'), 'Resolution', 300);
...
grid on
exportgraphics(gcf, fullfile('figures', 'ranging_PRN8_visible.png'), 'Resolution', 300);
