...
%                 col16: Cis, amplitude of the sine harmonic correction term to the angle of inclination
...
while 1
    ...
    if ~ischar(tline), break, end
        ...
        % This line only has the time of transmission of the message
